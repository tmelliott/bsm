...
makeModel <- function(family = "binomial", curve = "logistic", check.od = FALSE, od = FALSE,
    ...
    mAdd("## The following JAGS code was generated by the BSM package")
    mAdd("## on ", date(), ".")
    mAdd("## ")
    mAdd("## The code is free to use and modify. If you come across bugs,")
    mAdd("## please report them to Tom Elliott <tell029@aucklanduni.ac.nz>")
    mAdd("   ")
